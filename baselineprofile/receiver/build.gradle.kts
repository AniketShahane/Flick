...
android {
    namespace = "com.flick.baselineprofile.receiver"
    ...
    targetProjectPath = ":receiver"
}

baselineProfile {
    // The TV attached to adb. No Gradle-managed device is declared: a leanback
    // AVD does not reproduce the MediaTek decode path this profile exists for.
